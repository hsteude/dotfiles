...
wk.register({
  ...
  ["<leader>h"] = {
    name = "TTYD-Copy-Mode",
    a = { "<cmd>set nonumber norelativenumber mouse-=a scl=no<CR>", "Turn off line numbers and mouse support" },
    s = { "<cmd>set number relativenumber mouse+=a scl=yes<CR>", "And turn all back on" },
  },
  ["<leader>m"] = { "<cmd>!make<CR>", "Execute make file in this directory" },
  ["<C-l>"] = { ":nohlsearch<cr>:diffupdate<cr>:syntax sync fromstart<cr><c-l>", "..." },
  ["<leader>s"] = {
    name = "Spelllang",
    d = { "<cmd>setlocal spell spelllang=de<CR>", "Set spellcheck to German" },
    e = { "<cmd>setlocal spell spelllang=en<CR>", "Set spellcheck to English" },
    o = { "<cmd>setlocal nospell<CR>", "Turn off spellcheck" },
  },
  ["<leader>y"] = {
    name = "Clipboard",
    y = { '"+y', "Copy line to system clipboard" },
    w = { '"+yw', "Copy word to system clipboard" },
    i = { w = { '"+yiw', "Copy inner word to system clipboard" } },
    ["$"] = { '"+y$', "Copy to end of line to system clipboard" },
  },
})
